...
<title>Add Services and Product</title>
        ...
        <div id="contentwrapper" class="contentwrapper elements">
        	...
        	<div id="basicform" class="subcontent">
                    ...
                    <div class="contenttitle2">
                        <h3>Add Services and Product </h3>
                    </div><!--contenttitle-->
			...
			$status=1;
			$fields=array('name','images','createdate','status');
			$data=array($name,$objComm->uploadfile($_FILES["images"]["name"],$_FILES["images"]["tmp_name"]),$datetime,$status);
			$lastId=$objComm->insertWithLastid($fields,$data,'product_services');	
