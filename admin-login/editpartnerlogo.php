...
<?php include 'include/leftMenu.php' ?> 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
			...
			$img=$objComm->uploadfile($_FILES["logoimg"]["name"],$_FILES["logoimg"]["tmp_name"]);
			}
			...
			$objComm->db_update_record('partnerlogo',$update_arr,$where);
			...
			<?php
			$result=$objComm->singleRowFetch('partnerlogo','id',$_GET['id']);
			if($result[0][3]==1)
			...
			?>                	
						...
						<p>
                            ...
                            <span class="field"><input type="file" name="logoimg"   /></span>
                        </p>
                       <p>
                        	<label>&nbsp;</label>
