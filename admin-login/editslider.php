...
<?php include 'include/leftMenu.php' ?> 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
			...
			$video_link=$logohiden;
			}else{
			$video_link=$objComm->uploadfile1($_FILES["video_link"]["name"],$_FILES["video_link"]["tmp_name"]);
			}
			...
			$objComm->db_update_record('slider',$update_arr,$where);
			...
			<?php
			$result=$objComm->singleRowFetch('slider','id',$_GET['id']);
			if($result[0][3]==1)
		...
		<input type="hidden" name="logohiden" value="<?=$result[0][5]?>" />				
		</form>				
