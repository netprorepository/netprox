...
<title>Static Page Manager </title>
        ...
        <div id="contentwrapper" class="contentwrapper">
          ...
          <div class="contenttitle2">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <tbody>
                       <?php $query=$objComm->findAllRecord('staticpage');
					...
					?>
                        <tr class="gradeX">						
							...
							<td class="center"><a href="editstaticpagemanager.php?id=<?=$query[$i][0]?>" class="edit">Edit</a></td>
                        </tr>
					<?php
