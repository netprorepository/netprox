        ...
        <div id="contentwrapper" class="contentwrapper">
          ...
          <div class="contenttitle2">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <tbody>
                       <?php $query=$objComm->findAllRecord('slider');
					...
					?>
                        <tr class="gradeX">						
							...
							<td class="center"><a href="editslider.php?id=<?=$query[$i][0]?>" class="edit">Edit</a> &nbsp; &nbsp; &nbsp; <a href="" class="delete" onclick="return  deleteajax('slider','id',<?=$query[$i][0]?>);" >Delete</a> </td>
                        </tr>
					<?php
