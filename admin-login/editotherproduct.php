...
<title>Edit Other Products & Services </title>
        ...
        <div id="contentwrapper" class="contentwrapper elements">
        	...
        	<div id="basicform" class="subcontent">
                    ...
                    <div class="contenttitle2">
                        <h3>Edit Other Products & Services </h3>
                    </div><!--contenttitle-->
			...
			$objComm->db_update_record('home_otherproduct',$update_arr,$where);
			...
			?>	
				...
				<?php
				$result=$objComm->singleRowFetch('home_otherproduct','id',$_GET['id']);
				if($result[0][7]==1)
				...
				?>                	
						...
						<p>
                            ...
                            <span class="field">
							<textarea cols="80" rows="5" name="description" id="editor1"   class="longinput" /><?=$result[0][2]?></textarea>
						...
						<img src="projectimg/<?=$result[0][3]?>" width="100" />
						</span>
                        </p>
