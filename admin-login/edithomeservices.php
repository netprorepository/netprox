...
<title>Edit Home Services </title>
...
<?php include 'include/leftMenu.php' ?> 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
			...
			$objComm->db_update_record('service_home',$update_arr,$where);
			...
			<?php
			$result=$objComm->singleRowFetch('service_home','id',$_GET['id']);
			if($result[0][6]==1)
			...
			?>                	
						...
						<p>                        	<label>Url :</label>                            <span class="field"><textarea cols="80" rows="5" name="url"   class="longinput"> <?=$result[0][8]?></textarea></span>                        </p>
                       ...
                       <p>
                        	<label>&nbsp;</label>
                            <span class="field"><img src="projectimg/<?=$result[0][3]?>" style="width:150px; height:100px; background:black;" /></span>
                        </p>
						<p>
                        	<label>Image : </label>
                       ...
                       <p>
                        	<label>&nbsp;</label>
                            <span class="field"><img src="projectimg/<?=$result[0][4]?>" style="width:150px; height:100px; background:black;" /></span>
                        </p>
		...
		<input type="hidden" name="logohiden1" value="<?=$result[0][3]?>" />
		<input type="hidden" name="logohiden2" value="<?=$result[0][4]?>" />	
		</form>				
