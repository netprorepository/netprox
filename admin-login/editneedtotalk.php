...
<title>Edit Need To Talk With Us.</title>
        ...
        <div id="contentwrapper" class="contentwrapper elements">
        	...
        	<div id="basicform" class="subcontent">
                    ...
                    <div class="contenttitle2">
                        <h3>Edit Need To Talk With Us. </h3>
                    </div><!--contenttitle-->
			...
			$objComm->db_update_record('needto_talk',$update_arr,$where);
			...
			<?php
			$result=$objComm->singleRowFetch('needto_talk','id',$_GET['id']);
			...
			?>                	
						...
						<p>
                        	<label>Phone : </label>
                            <span class="field"><input type="text" name="phone" value="<?php echo $result[0][2];?>"   /></span>
                        </p>
