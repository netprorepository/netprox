...
<title>Add Other Products & Services </title>
        ...
        <div id="contentwrapper" class="contentwrapper elements">
        	...
        	<div id="basicform" class="subcontent">
                    ...
                    <div class="contenttitle2">
                        <h3>Add Other Products & Services </h3>
                    </div><!--contenttitle-->
			...
			$sql="insert into home_otherproduct (heading,description,images,seo_titel,seo_keyword,seo_description,status) values ('$heading','$editor1','$images','$seo_titel','$seo_keyword','$seo_description','$status')";
