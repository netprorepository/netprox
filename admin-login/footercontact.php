...
<title>Edit Footer Contact.</title>
...
<?php include 'include/leftMenu.php' ?> 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
			...
			$objComm->db_update_record('footer_contact',$update_arr,$where);
			...
			<?php
			$result=$objComm->singleRowFetch('footer_contact','id',$_GET['id']);
			
			?>                	
						                       
                        <p>
                        	<label>Email :</label>
                            <span class="field"><input type="text" name="email" value="<?php echo $result[0][2];?>"   /></span>
                        </p>
