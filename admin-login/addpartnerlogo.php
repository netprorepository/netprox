...
<?php include 'include/leftMenu.php' ?> 
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
			...
			$status=1;
			$fields=array('name','logoimg','createdate','status');
			$data=array($name,$objComm->uploadfile($_FILES["logoimg"]["name"],$_FILES["logoimg"]["tmp_name"]),$datetime,$status);
			$lastId=$objComm->insertWithLastid($fields,$data,'partnerlogo');	
