...
<div class="breadcrumb">
 ...
 <div class="col-md-6 center-block fl-none">
   <h2>Fill the form  to send request for demo</h2>
   <script src="<?=BASE_URL?>/scripts/gen_validatorv31.js" type="text/javascript"></script>
   <form method="POST" name="contact" action="<?=BASE_URL?>/request-form.php">
<ul class="form-team">
  
   
   <li class="col-md-12"><label>Organization Name <span>*</span></label>
    <input type="text" class="form-control" name="organization" required  />
   </li>
   
   <li class="col-md-12"><label>Your Name <span>*</span></label>
    <input type="text" class="form-control" name="name" required />
   </li>
   
   <li class="col-md-12"><label>Your Email <span>*</span></label>
    <input type="text" class="form-control" name="email" required />
   </li>
   
   <li class="col-md-12"><label>Your Contact Phone Number <span>*</span></label>
    <input type="text" class="form-control" name="phone" required />
   </li>
   
   <li class="col-md-12"><label>Choose Service <span>*</span></label>
    <select class="form-control" name="services" id="services" required >
     <option value="">Select Services</option>
     <option value="Education">Education</option>
     <option value="Healthcare">Healthcare</option>
     <option value="Hospitality">Hospitality</option>
     <option value="Training and Consultancy">Training &amp; Consultancy</option>
    </select>
   </li>
   
   <li class="col-md-12"><label>Choose Country <span>*</span></label>
   ...
   <li class="col-md-12 ">
    <input type="submit" class="bigbtn btn center-block col-md-12 fl-none m-auto d-inherit" value="Submit">   
   </li>
  </ul>
  </form>
...
frmvalidator.addValidation("organization","req","Please select your organization");
frmvalidator.addValidation("name","req","Please provide your name");
frmvalidator.addValidation("email","req","Please provide your email"); 
frmvalidator.addValidation("email","email","Please enter a valid email address");
frmvalidator.addValidation("phone","req","Please type your phone number");
frmvalidator.addValidation("services","req","Select the service");
frmvalidator.addValidation("country","req","Select your country"); 
</script> 
